...
btc_eur %>%
  ...
  head(n = 1)
```
In date 01/01/2014, one bitcoin was worth `815` euros.
```{r}
btc_eur %>%
...
This clearly may represent a problem in our analysis, because we lack a time reference indicating the exact date of sale of items. So we use this dataset as a mean to obtain an exchange rate which is as reliable as possible.
```{r}
