...
```{r}
tier1 <-
  get_tier_data(categories, 1, 10)
tier1
```
# TODO: Boxplot of prices per category to identify means and outliers. Modify functions to transform even the second column into a variable.
