...
agora %>%
  ...
  geom_histogram()
```
We see that bad ratings are very rare: most ratings are among 4 and 5, with a very high number of vendors with max ratings. **This may mean that the market is a "safe" place where to buy the kind of items it offers.**
